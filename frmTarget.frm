...
targetType = "" 'public variable
    ...
    If Me.chkEnableLimit.Value = True And Len(Me.txtLimitVal) > 0 Then
    ...
    If Me.chkEnableCompliant.Value = True And Len(Me.txtCompliantVal.Value) > 0 Then
