...
If btnOkPressed = False Then End
    ...
    If T_BandType = "oct" Then
        ...
        SetDescription "ISO9613: A_gr"
            ...
            Else
            Cells(Selection.Row, T_LossGainStart).Value = "=ISO9613_Agr(" & T_FreqStartRng & "," & iso9613_SourceHeight & "," & iso9613_ReceiverHeight & "," & _
        ...
        SetUnits "m", T_ParamStart, 1
            ...
            Cells(Selection.Row, T_LossGainStart).Value = "=ISO9613_Abar(" & T_FreqStartRng & "," & iso9613_SourceHeight & "," & iso9613_ReceiverHeight & ",$N" & Selection.Row - 3 & "," & iso9613_SourceToBarrier & "," & _
            ...
            Else
            Cells(Selection.Row, T_LossGainStart).Value = "=ISO9613_Abar(" & T_FreqStartRng & "," & iso9613_SourceHeight & "," & iso9613_ReceiverHeight & "," & iso9613_d & "," & iso9613_SourceToBarrier & "," & _
            iso9613_SrcToBarrierEdge & "," & iso9613_RecToBarrierEdge & "," & "$N" & Selection.Row & "," & iso9613_DoubleDiffraction & "," & iso9613_BarrierThickness & "," & _
            iso9613_BarrierHeightReceiverSide & "," & iso9613_MultiSource & ",E$" & Selection.Row - 1 & ")"
            End If
