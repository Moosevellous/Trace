...
''''''''''''''''''''''''
'TODO_______STORE VALUES
''''''''''''''''''''''''
CompressorSPL(0) = CLng(Me.txt31Lw.Value)
CompressorSPL(1) = CLng(Me.txt63Lw.Value)
CompressorSPL(2) = CLng(Me.txt125Lw.Value)
CompressorSPL(3) = CLng(Me.txt250Lw.Value)
CompressorSPL(4) = CLng(Me.txt500Lw.Value)
CompressorSPL(5) = CLng(Me.txt1kLw.Value)
CompressorSPL(6) = CLng(Me.txt2kLw.Value)
CompressorSPL(7) = CLng(Me.txt4kLw.Value)
CompressorSPL(8) = CLng(Me.txt8kLw.Value)
