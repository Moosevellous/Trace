...
' Originally from Army, Air Force and Navy USE 1983a
    If IsNumeric(txtPower.Value) And Me.txtPower.Value <> 0 Then
        ...
        Me.optUnder75kW.Value = True
            ...
            DescriptionString = "Pump Estimate (<75kW 450-900RPM)"
            ...
            DescriptionString = "Pump Estimate (<75kW 1000-1500RPM)"
            ...
            DescriptionString = "Pump Estimate (<75kW 1600-1800RPM)"
            ...
            DescriptionString = "Pump Estimate (<75kW 3000-3600RPM)"
            Else
            Me.lblEqn.Caption = ""
            End If
