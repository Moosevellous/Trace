...
GotoWikiPage ("Estimator-Functions#cooling-tower")
End Sub
...
Private Sub btnOK_Click()
    ...
    Else
            ...
            CTEqn = Me.lblEqn.Caption
                ...
                CT_Dir_checked = True
                CT_Directivity(0) = Me.txt31dir.Value
                CT_Directivity(1) = Me.txt63dir.Value
                CT_Directivity(2) = Me.txt125dir.Value
                CT_Directivity(3) = Me.txt250dir.Value
                CT_Directivity(4) = Me.txt500dir.Value
                CT_Directivity(5) = Me.txt1kdir.Value
                CT_Directivity(6) = Me.txt2kdir.Value
                CT_Directivity(7) = Me.txt4kdir.Value
